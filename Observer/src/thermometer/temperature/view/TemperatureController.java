...
import thermometer.temperature.mediator.PropertyChangeSubject;
...
public class TemperatureController {
    ...
    public TemperatureController(PropertyChangeSubject subject) {
        subject.addPropertyChangeListener("valueChanged", this::changeLabel);
    }

    private void changeLabel(PropertyChangeEvent event) {
        Platform.runLater(()-> {
            outputLabel.setText((String) event.getNewValue());
        });
    }
